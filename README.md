...
-'poisson/SOL2_0' contains the necessary source code of the SOL models, and we refer to [OPNO](https://github.com/liu-ziyuan-math/spectral_operator_learning) and [SPFNO](https://github.com/liu-ziyuan-math/SPFNO) for details.
